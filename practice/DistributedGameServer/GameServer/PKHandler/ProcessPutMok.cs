    ...
    public partial class Process
    {
        void HandlerRequestPutMok(EFBinaryRequestInfo packetData)
        {
            ...
            try
            {
                ...
                // 목 두기
                var nextMok = reqData.isSkip ? Rooms.Mok.Skip : roomUser.UserMok;
                var errorCode = room.PutMok(nextMok, reqData.PosX, reqData.PosY, reqData.Turn);
