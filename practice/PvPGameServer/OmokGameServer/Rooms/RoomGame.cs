...
namespace PvPGameServer.Rooms
{
    public partial class Room
    {
        ...
        public ErrorCode PutMok(string playerSessionID, Mok mok, int posX, int posY)
        {
            if (OmokBrd == null)
            {
            ...
            // 목 두기
            var putErrorCode = OmokBrd.PutMok(mok, posX, posY);
            ...
            Broadcast(playerSessionID, sendData);
        ...
        public Tuple<int, string> GetCurTurnInfo()
        {
            ...
            var curMok = OmokBrd.TurnCount % 2 == 0 ? Mok.White : Mok.Black;
            ...
            return new Tuple<int, string>(OmokBrd.TurnCount, sessionID);
        }
